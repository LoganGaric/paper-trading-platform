...
const createInstruments = async () => {
  ...
  const instrumentsData = [
    ...
    },
    {
      ...
      tickSize: 0.01,
      lotSize: 1,
      referencePrice: 875.30,
      price: 875.30,
      previousClose: 872.15,
      isActive: true,
    },
    {
      symbol: 'SPY',
      ...
      tickSize: 0.01,
      lotSize: 1,
      referencePrice: 547.89,
      price: 547.89,
      previousClose: 546.12,
      isActive: true,
    }
  ];
